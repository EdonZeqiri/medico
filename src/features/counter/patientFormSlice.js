...
//step4
export const selectDoctorInfoImage = state => state.patientForm.doctorInfo.image
export const selectDoctorInfoName = state => state.patientForm.doctorInfo.name
...
export const selectPatientGender = state => state.patientForm.patinetGenderMaleOrFemale
